...
| Source | Tool | Result |
|---|---|---|
| Gangtise | knowledge batch | ✅ pulled |
| Gangtise | income-statement | ✅ pulled |
| Gangtise | top-holders | ✅ pulled |
...
LLM: 读 sk-company-deepdive/SKILL.md
LLM: 加载 §1-§6 的内容（已完成的）
LLM: 从 §7 继续工作
LLM: 完成 §7-§9
...
### Q: 任务没有明确 9 段结构（比如 sk-briefing）怎么 checkpoint？
...
每个 sk-* skill 在设计时必须支持 checkpoint。必要条件：
